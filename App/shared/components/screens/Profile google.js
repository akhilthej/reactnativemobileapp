                ...
                <View className='p-8 bg-white mt-[-20px] rounded-3xl'>
                    ...
                    {isLoggedIn ? (
                        <TouchableOpacity onPress={handleLogout}>
                            <Text className='bg-red-500 rounded-md p-3 mt-5 text-[20px] text-center font-bold text-white px-22' >Log Out</Text>
                        </TouchableOpacity>
                    ) : (
                        <TouchableOpacity onPress={handleGoogleLogin}>
                            <Text className='bg-teal-700 rounded-md p-3 mt-5 text-[20px] text-center font-bold text-white px-22' >Sign In</Text>
